...
function setup(){
    ...
    Restart = createSprite(width/2,height-290,30,30);
...
function spawnClouds() {
        if(frameCount%120 === 0){
            cloud = createSprite(width/2,height-50,30,30);
            cloud.y = Math.round(random(width-180,width-100));
...
function spawnObstacles() {
    if (frameCount%170 === 0) {
        obstacle = createSprite(width/2,height-50,30,30)
